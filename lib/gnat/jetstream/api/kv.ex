defmodule Gnat.Jetstream.API.KV do
  ...
  * `:batch` - Number of messages to fetch per request (default: 250). This has been optimized
    through benchmarking. Adjust if needed based on your bucket size and network conditions.
